...
export const currentThemeIsDark: Ui["currentThemeIsDark"] = mod.currentThemeIsDark;
export const resolveColor: Ui["resolveColor"] = mod.resolveColor;
export const isThemeColor: Ui["isThemeColor"] = mod.isThemeColor;
export const applyAdaptiveColor: Ui["applyAdaptiveColor"] = mod.applyAdaptiveColor;
...
export { For } from "./jsx-runtime.tsx";
