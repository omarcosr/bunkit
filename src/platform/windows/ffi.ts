...
function getLib(): any {
  ...
  bk_control_set_corner_radius: { args: ["u64", "f64"], returns: "i32" },
  bk_control_set_border: { args: ["u64", "ptr", "u32", "f64", "f64"], returns: "i32" },
  bk_control_set_border_style: { args: ["u64", "ptr", "u32", "f64", "f64", "i32"], returns: "i32" },
