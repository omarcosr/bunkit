...
function getLib(): any {
  ...
  _lib = dlopen(getPath(), {
    ...
    bk_window_set_titlebar: {
      args: ["u64", "i32", "i32", "ptr", "u32", "ptr", "u32"],
      returns: "i32",
    },
    bk_window_show_titlebar: { args: ["u64", "i32", "ptr", "u32", "ptr", "u32"], returns: "i32" },
    bk_window_set_style: { args: ["u64", "i32", "i32", "i32"], returns: "i32" },
    ...
    bk_control_get_enabled: { args: ["u64"], returns: "i32" },
    ...
    bk_button_set_color: { args: ["u64", "ptr", "u32"], returns: "i32" },
    bk_button_set_font: { args: ["u64", "f64", "i32"], returns: "i32" },
    bk_label_create_ex: {
      args: ["ptr", "u32", "ptr", "u32", "f64", "i32", "i32", "f64", "f64"],
      returns: "u64",
    },
    ...
    bk_control_set_cursor: { args: ["u64", "i32"], returns: "i32" },
    bk_control_set_background: { args: ["u64", "ptr", "u32"], returns: "i32" },
    bk_control_set_shadow: {
      args: ["u64", "ptr", "u32", "f64", "f64", "f64", "f64"],
      returns: "i32",
    },
    ...
    bk_control_set_border_style: {
      args: ["u64", "ptr", "u32", "ptr", "ptr", "i32"],
      returns: "i32",
    },
    ...
    bk_textbox_reset_placeholder_color: { args: ["u64"], returns: "i32" },
