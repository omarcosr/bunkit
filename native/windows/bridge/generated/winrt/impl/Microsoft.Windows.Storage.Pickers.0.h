...
{
    enum class PickerLocationId : std::int32_t
    {
        DocumentsLibrary = 0,
        ComputerFolder = 1,
        Desktop = 2,
    ...
    enum class PickerViewMode : std::int32_t
    {
        List = 0,
        Thumbnail = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::Storage::Pickers::IFileOpenPicker>
    {
        ...
        {
            virtual std::int32_t __stdcall get_ViewMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ViewMode(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_SuggestedStartLocation(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SuggestedStartLocation(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CommitButtonText(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CommitButtonText(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_FileTypeFilter(void**) noexcept = 0;
            virtual std::int32_t __stdcall PickSingleFileAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall PickMultipleFilesAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Storage::Pickers::IFileOpenPickerFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(struct struct_Microsoft_UI_WindowId, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Storage::Pickers::IFileSavePicker>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_CommitButtonText(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CommitButtonText(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_FileTypeChoices(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DefaultFileExtension(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DefaultFileExtension(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SuggestedFileName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SuggestedFileName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_SuggestedFolder(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_SuggestedFolder(void*) noexcept = 0;
            virtual std::int32_t __stdcall PickSaveFileAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::Storage::Pickers::IFolderPicker>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_CommitButtonText(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CommitButtonText(void*) noexcept = 0;
            virtual std::int32_t __stdcall PickSingleFolderAsync(void**) noexcept = 0;
        };
    };
