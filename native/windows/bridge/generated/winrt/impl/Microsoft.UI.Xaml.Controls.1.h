...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Controls
{
    ...
    struct WINRT_IMPL_EMPTY_BASES ISplitMenuFlyoutItem :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ISplitMenuFlyoutItem>
    {
        ISplitMenuFlyoutItem(std::nullptr_t = nullptr) noexcept {}
        ISplitMenuFlyoutItem(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    struct WINRT_IMPL_EMPTY_BASES ISplitMenuFlyoutItemFactory :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ISplitMenuFlyoutItemFactory>
    {
        ISplitMenuFlyoutItemFactory(std::nullptr_t = nullptr) noexcept {}
        ISplitMenuFlyoutItemFactory(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    struct WINRT_IMPL_EMPTY_BASES ISplitMenuFlyoutItemStatics :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ISplitMenuFlyoutItemStatics>
    {
        ISplitMenuFlyoutItemStatics(std::nullptr_t = nullptr) noexcept {}
        ISplitMenuFlyoutItemStatics(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
