...
{
    enum class ApplicationDataCreateDisposition : std::int32_t
    {
        Always = 0,
        Existing = 1,
    };
    enum class ApplicationDataLocality : std::int32_t
    {
        Local = 0,
        LocalCache = 3,
        SharedLocal = 4,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::Storage::IApplicationData>
    {
        ...
        {
            virtual std::int32_t __stdcall get_IsMachinePathSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_LocalCachePath(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LocalPath(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MachinePath(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SharedLocalPath(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TemporaryPath(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LocalCacheFolder(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LocalFolder(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MachineFolder(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SharedLocalFolder(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TemporaryFolder(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LocalSettings(void**) noexcept = 0;
            virtual std::int32_t __stdcall ClearAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall ClearPublisherCacheFolderAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPublisherCachePath(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPublisherCacheFolder(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Storage::IApplicationDataContainer>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Containers(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Name(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Locality(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Values(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateContainer(void*, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeleteContainer(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Storage::IApplicationDataStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetForUser(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetForPackageFamily(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
